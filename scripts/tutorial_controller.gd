...
var STEP_3_TEXT = "Good, now drop it on the floor."
var STEP_4_TEXT = "Create a second Block and bring it close to the first one to snap it."
var STEP_5_TEXT = "That's why it's called Snap Blocks :-) Do one more!"
var STEP_6_TEXT = "Awesome! You can change the color of the Block by pressing your joystick to the left or right. Try it."
var STEP_7_TEXT = "Perfect. Now create a new Block and snap it to the others."
var STEP_8_TEXT = "Great! You can also change the color of a Block that's already snapped. Press A to change to the re-coloring tool."
var STEP_9_TEXT = "Good. Now touch a Block with the tip of your tool and press index trigger to change its color."
var STEP_10_TEXT = "Good job! You can also delete Blocks. Press A again to change to the delete tool."
var STEP_11_TEXT = "To delete a Block, touch it with the tip of your tool and press the index trigger."
